...
weight: 2
description: >
  How to install and activate the Injectable Agent Skill in your Dart and Flutter projects.
---

Follow this guide to equip your AI assistant with the Injectable Agent Skill.

---

## 1. Adding the Skill to Your Project

You can copy the official Injectable skill into your project's agent skill directory.
...
# Copy the skill from the injectable-dart repository
...
- **Claude Code**: `.claude/skills/injectable/` or `.agents/skills/injectable/`
- **Antigravity / Gemini CLI**: `.agents/skills/injectable/` or `.gemini/skills/injectable/`
- **Cursor**: `.cursor/skills/injectable/` or `.agents/skills/injectable/`
...
```text
Set up Injectable and GetIt in my Flutter app with support for folder-scoped micro-packages.
```
